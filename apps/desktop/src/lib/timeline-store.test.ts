...
function item(id: string, over: Partial<WireHistoryItem> = {}): WireHistoryItem {
  return {
    id,
    mode: 'realtime',
    status: 'injected',
...
function fresh(): { store: TimelineStore; t: RecordingTransport } {
...
function verdict(rowId: string, over: Partial<InjectResult> = {}): InjectResult {
...
function seed(store: TimelineStore, rows: WireHistoryItem[], channel: ChannelTag = 'lan'): void {
