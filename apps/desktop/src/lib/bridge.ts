...
// re-exported here so every existing `import { CH } from './bridge'` still
// resolves and this file keeps its one invariant — being the only module that
// imports `invoke`.
export { CH, UI_NAVIGATE, UI_PREFS_SYNC } from './bridge-channels';
import { UI_NAVIGATE, UI_PREFS_SYNC } from './bridge-channels';
